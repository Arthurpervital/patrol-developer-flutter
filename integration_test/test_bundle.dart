...
import 'tests/cadastro_test.dart' as tests__cadastro_test;
import 'tests/cadastrofalided_test.dart' as tests__cadastrofalided_test;
import 'tests/delete_test.dart' as tests__delete_test;
import 'tests/edit_test.dart' as tests__edit_test;
import 'tests/loginfalided_test.dart' as tests__loginfalided_test;
import 'tests/loginsucess_test.dart' as tests__loginsucess_test;
import 'tests/signup_test.dart' as tests__signup_test;
...
Future<void> main() async {
  ...
  group('tests.cadastro_test', tests__cadastro_test.main);
  group('tests.cadastrofalided_test', tests__cadastrofalided_test.main);
  group('tests.delete_test', tests__delete_test.main);
  group('tests.edit_test', tests__edit_test.main);
  group('tests.loginfalided_test', tests__loginfalided_test.main);
  group('tests.loginsucess_test', tests__loginsucess_test.main);
  group('tests.signup_test', tests__signup_test.main);
