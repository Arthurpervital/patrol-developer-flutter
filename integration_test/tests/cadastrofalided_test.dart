...
void main() {
  patrolTest('cadastro de aluno falha', (PatrolIntegrationTester $) async {
    app.main();
    ...
    await Cadastro().informDados($, 'João', '', '36748890306', '12345', 'joao@roooot.com');
    await Cadastro().tapButtonAddOrEdit($);
    await Cadastro().camposObrigatorios($);
  });
}
